...
class RemarksControllerTest < ActionController::TestCase
  ...
  test "should create remark" do
    assert_difference('Remark.count') do
      post :create, remark: { body: @remark.body, bookmark_id: @remark.bookmark_id, user_id: @remark.user_id }
    end
  ...
  test "should update remark" do
    patch :update, id: @remark, remark: { body: @remark.body, bookmark_id: @remark.bookmark_id, user_id: @remark.user_id }
    assert_redirected_to remark_path(assigns(:remark))
  end
